...
use [C:\USERS\MAKS\SOURCE\REPOS\EKZAMEN_SQL\EKZAMEN_SQL\DATABASE1.MDF]
...
Constraint Fk_Hv11 foreign key(CountryId) references Country(Id) ,
...
Constraint Fk_so02 foreign key(HistoryVisitCountryId) references HistoryVisitCountry(Id) ,
